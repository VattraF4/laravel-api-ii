...
<body>
    ...
    <div class="container">
        ...
        <a href="{{ route('posts.web.show', $post->id) }}" class="button"
            style="display: inline-block; padding: 10px 20px; background-color: #007bff; color: #ffffff; text-decoration: none; border-radius: 5px;">View
            Post</a>
